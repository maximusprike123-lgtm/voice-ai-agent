...
- **Eval runs:** a sweep I decide to run myself: up to $0.50 without asking, ask first if the
  estimate is higher. A sweep you ask for explicitly is already allowed at any price. Either
  way, show the `--dry-run` cost estimate BEFORE starting it.
